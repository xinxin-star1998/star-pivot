...
flowchart TB
    ...
    subgraph Ctrl["控制层 star-pivot-controller"]
        Ctl["REST Controller<br/>auth / system / file / monitor ..."]
    end
    ...
    subgraph Biz["业务模块层 star-pivot-module"]
        ...
        M_file["star-pivot-file<br/>文件中心"]
    end
...
| 基础设施 | MySQL 持久化；Redis 缓存与令牌；阿里云 OSS 文件 |
