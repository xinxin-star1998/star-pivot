...
import com.star.pivot.generator.service.GenExternalService;
...
public class GenExternalController {
    ...
    @Log(title = "外部库代码生成下载", businessType = AppConstants.BusinessType.GENCODE)
    ...
    @Log(title = "外部库代码写盘生成", businessType = AppConstants.BusinessType.GENCODE)
    @PreAuthorize("hasAuthority('tool:external:create')")
    @PostMapping("/write")
    ...
    @Log(title = "外部库导入代码生成", businessType = AppConstants.BusinessType.IMPORT)
    @PreAuthorize("hasAuthority('tool:external:create')")
    ...
    @Log(title = "外部库代码写盘回退", businessType = AppConstants.BusinessType.GENCODE)
    @PreAuthorize("hasAuthority('tool:external:create')")
