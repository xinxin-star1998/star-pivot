<template>
  <div
    ref="panelRef"
    class="chat-session-panel flex h-full flex-col border-r border-g-300/60 bg-g-100/30"
  >
    ...
    <div class="flex-1 overflow-y-auto px-2 py-2 [&::-webkit-scrollbar]:!w-1">
      ...
      >
        <div class="min-w-0 flex-1">
          ...
          <div class="mt-0.5 text-[11px] text-g-500">{{
      ...
      <div v-if="!sessions.length" class="px-2 py-6 text-center text-xs text-g-500"
        >暂无历史对话</div
      >
    </div>
  </div>
