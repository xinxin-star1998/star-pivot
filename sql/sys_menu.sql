...
INSERT INTO `sys_menu` VALUES (107, '彻底删除', 25, 11, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:resource:purge', '#', 'admin', '2026-07-16 11:34:40', '', NULL, '回收站彻底删除并清理OSS');
INSERT INTO `sys_menu` VALUES (108, '清空回收站', 25, 12, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:resource:purge', '#', 'admin', '2026-07-16 11:34:40', '', NULL, '清空回收站（与彻底删除同权限）');
INSERT INTO `sys_menu` VALUES (109, '文件分享', 25, 13, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:resource:share', '#', 'admin', '2026-07-16 12:15:49', '', NULL, '创建/管理分享外链');
INSERT INTO `sys_menu` VALUES (110, '批量下载', 25, 14, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:resource:download', '#', 'admin', '2026-07-16 12:51:20', '', NULL, '批量打包下载 ZIP');
INSERT INTO `sys_menu` VALUES (111, '文件标签', 25, 15, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:resource:tag', '#', 'admin', '2026-07-16 12:51:20', '', NULL, '标签管理与打标');
INSERT INTO `sys_menu` VALUES (112, '文件版本', 25, 16, '', '', NULL, '', 1, 1, 'F', '0', '0', 'file:resource:version', '#', 'admin', '2026-07-16 13:04:48', '', NULL, '上传新版本/历史/恢复');
